...
public class ProductFrame_3 implements ActionListener{
	JFrame f;
	...
	JPanel panel1 = new MyPanel1p3();

	JPanel panel1_1 = new MyPanel1_1p3();
	JPanel panel1_2 = new MyPanel1_2p3();
	JPanel panel1_3 = new MyPanel1_3p3();
	JPanel panel1_4 = new MyPanel1_4p3();
	JPanel panel1_5 = new MyPanel1_5p3();
	JPanel panel1_6 = new MyPanel1_6p3();
	...
	final double priceIce1 = 139;
	final double priceIce2 = 129;
	final double priceIce3 = 139;
	final double priceIce4 = 129;
	final double priceIce5 = 139;
	final double priceIce6 = 129;
	...
	JLabel label1_1_4 = new JLabel("Creamy Tomato Pasta Non-Veg");
	JLabel label1_2_4 = new JLabel("Creamy Tomato Pasta Veg");
	JLabel label1_3_4 = new JLabel("Moroccan Spice Pasta Non-Veg");
	JLabel label1_4_4 = new JLabel("Tikka Masala Pasta Veg");
	JLabel label1_5_4 = new JLabel("Tikka Masala Pasta Non-Veg");
	JLabel label1_6_4 = new JLabel("Moroccan Spice Pasta Veg");

	JButton back = new JButton("Back");

	ProductFrame_3(String str){
		f = new JFrame();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == button1_1_1){
			...
			if(radiobutton1_1_1.isSelected()){
				productname = "Creamy Tomato Pasta Non-Veg - regular";
				quantity = label1_1_1.getText();
				totalprice = label1_1_3.getText();
			}
			else if(radiobutton1_1_2.isSelected()){
				productname = "Creamy Tomato Pasta Non-Veg - medium";
				quantity = label1_1_1.getText();
				totalprice = label1_1_3.getText();
			}
			else if(radiobutton1_1_3.isSelected()){
				productname = "Creamy Tomato Pasta Non-Veg - large";
				quantity = label1_1_1.getText();
				totalprice = label1_1_3.getText();
			}
		...
		if(e.getSource() == button1_2_1){
			...
			if(radiobutton1_2_1.isSelected()){
				productname = "Creamy Tomato Pasta Veg - regular";
				quantity = label1_2_1.getText();
				totalprice = label1_2_3.getText();
			}
			else if(radiobutton1_2_2.isSelected()){
				productname = "Creamy Tomato Pasta Veg - medium";
				quantity = label1_2_1.getText();
				totalprice = label1_2_3.getText();
			}
			else if(radiobutton1_2_3.isSelected()){
				productname = "Creamy Tomato Pasta Veg - large";
				quantity = label1_2_1.getText();
				totalprice = label1_2_3.getText();
			}
		...
		if(e.getSource() == button1_3_1){
			...
			if(radiobutton1_3_1.isSelected()){
				productname = "Moroccan Spice Pasta Non-Veg - regular";
				quantity = label1_3_1.getText();
				totalprice = label1_3_3.getText();
			}
			else if(radiobutton1_3_2.isSelected()){
				productname = "Moroccan Spice Pasta Non-Veg - medium";
				quantity = label1_3_1.getText();
				totalprice = label1_3_3.getText();
			}
			else if(radiobutton1_3_3.isSelected()){
				productname = "Moroccan Spice Pasta Non-Veg - large";
				quantity = label1_3_1.getText();
				totalprice = label1_3_3.getText();
			}
		...
		if(e.getSource() == button1_5_1){
			...
			if(radiobutton1_5_1.isSelected()){
				productname = "Tikka Masala Pasta Non-Veg - regular";
				quantity = label1_5_1.getText();
				totalprice = label1_5_3.getText();
			}
			else if(radiobutton1_5_2.isSelected()){
				productname = "Tikka Masala Pasta Non-Veg - medium";
				quantity = label1_5_1.getText();
				totalprice = label1_5_3.getText();
			}
			else if(radiobutton1_5_3.isSelected()){
				productname = "Tikka Masala Pasta Non-Veg - large";
				quantity = label1_5_1.getText();
				totalprice = label1_5_3.getText();
			}
		...
		if(e.getSource() == button1_6_1){
			...
			if(radiobutton1_6_1.isSelected()){
				productname = "Moroccan Spice Pasta Veg - regular";
				quantity = label1_6_1.getText();
				totalprice = label1_6_3.getText();
			}
			else if(radiobutton1_6_2.isSelected()){
				productname = "Moroccan Spice Pasta Veg - medium";
				quantity = label1_6_1.getText();
				totalprice = label1_6_3.getText();
			}
			else if(radiobutton1_6_3.isSelected()){
				productname = "Moroccan Spice Pasta Veg - large";
				quantity = label1_6_1.getText();
				totalprice = label1_6_3.getText();
			}
	...
	private void setIconInPanel1_1(){
		i1_1 = new ImageIcon("pastha1.jpg");
	...
	private void setIconInPanel1_2(){
		i1_2 = new ImageIcon("pastha2.jpg");
	...
	private void setIconInPanel1_3(){
		i1_3 = new ImageIcon("pastha3.jpg");
	...
	private void setIconInPanel1_4(){
		i1_4 = new ImageIcon("pastha4.jpg");
	...
	private void setIconInPanel1_5(){
		i1_5 = new ImageIcon("pastha5.jpg");
	...
	private void setIconInPanel1_6(){
		i1_6 = new ImageIcon("pastha6.jpg");
...
class MyPanel1p3 extends RoundedPanel{
...
class MyPanel1_1p3 extends RoundedPanel{
...
class MyPanel1_2p3 extends RoundedPanel{
...
class MyPanel1_3p3 extends RoundedPanel{
...
class MyPanel1_4p3 extends RoundedPanel{
...
class MyPanel1_5p3 extends RoundedPanel{
...
class MyPanel1_6p3 extends RoundedPanel{
