...
public class ProductFrame_2 implements ActionListener{
	JFrame f;
	...
	JPanel panel1 = new MyPanel1p2();

	JPanel panel1_1 = new MyPanel1_1p2();
	JPanel panel1_2 = new MyPanel1_2p2();
	JPanel panel1_3 = new MyPanel1_3p2();
	JPanel panel1_4 = new MyPanel1_4p2();
	JPanel panel1_5 = new MyPanel1_5p2();
	JPanel panel1_6 = new MyPanel1_6p2();
	...
	final double priceIce1 = 145;
	final double priceIce2 = 105;
	final double priceIce3 = 135;
	final double priceIce4 = 105;
	final double priceIce5 = 135;
	final double priceIce6 = 50;
	...
	JLabel label1_1_4 = new JLabel("Burger Pizza-Classic Non-Veg");
	JLabel label1_2_4 = new JLabel("Burger Pizza-Classic Veg");
	JLabel label1_3_4 = new JLabel("Burger Pizza-Premimum Veg");
	JLabel label1_4_4 = new JLabel("Masala whopper Veg");
	JLabel label1_5_4 = new JLabel("Masala whopper Non-Veg");
	JLabel label1_6_4 = new JLabel("Aloo Tikka Masala");

	JButton back = new JButton("Back");

	ProductFrame_2(String str){
		f = new JFrame();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == button1_1_1){
			...
			if(radiobutton1_1_1.isSelected()){
				productname = "Burger Pizza-Classic Non-Veg - regular";
				quantity = label1_1_1.getText();
				totalprice = label1_1_3.getText();
			}
			else if(radiobutton1_1_2.isSelected()){
				productname = "Burger Pizza-Classic Non-Veg - medium";
				quantity = label1_1_1.getText();
				totalprice = label1_1_3.getText();
			}
			else if(radiobutton1_1_3.isSelected()){
				productname = "Burger Pizza-Classic Non-Veg - large";
				quantity = label1_1_1.getText();
				totalprice = label1_1_3.getText();
			}
		...
		if(e.getSource() == button1_2_1){
			...
			if(radiobutton1_2_1.isSelected()){
				productname = "Burger Pizza-Classic Veg - regular";
				quantity = label1_2_1.getText();
				totalprice = label1_2_3.getText();
			}
			else if(radiobutton1_2_2.isSelected()){
				productname = "Burger Pizza-Classic Veg - medium";
				quantity = label1_2_1.getText();
				totalprice = label1_2_3.getText();
			}
			else if(radiobutton1_2_3.isSelected()){
				productname = "Burger Pizza-Classic Veg - large";
				quantity = label1_2_1.getText();
				totalprice = label1_2_3.getText();
			}
		...
		if(e.getSource() == button1_3_1){
			...
			if(radiobutton1_3_1.isSelected()){
				productname = "Burger Pizza-Premimum Veg - regular";
				quantity = label1_3_1.getText();
				totalprice = label1_3_3.getText();
			}
			else if(radiobutton1_3_2.isSelected()){
				productname = "Burger Pizza-Premimum Veg - medium";
				quantity = label1_3_1.getText();
				totalprice = label1_3_3.getText();
			}
			else if(radiobutton1_3_3.isSelected()){
				productname = "Burger Pizza-Premimum Veg - large";
				quantity = label1_3_1.getText();
				totalprice = label1_3_3.getText();
			}
	...
	private void setIconInPanel1_1(){
		i1_1 = new ImageIcon("burger1.jpg");
	...
	private void setIconInPanel1_2(){
		i1_2 = new ImageIcon("burger2.jpg");
	...
	private void setIconInPanel1_3(){
		i1_3 = new ImageIcon("burger3.jpg");
	...
	private void setIconInPanel1_4(){
		i1_4 = new ImageIcon("burger4.jpg");
	...
	private void setIconInPanel1_5(){
		i1_5 = new ImageIcon("burger5.jpg");
	...
	private void setIconInPanel1_6(){
		i1_6 = new ImageIcon("burger6.jpg");
...
class MyPanel1p2 extends RoundedPanel{
...
class MyPanel1_1p2 extends RoundedPanel{
...
class MyPanel1_2p2 extends RoundedPanel{
...
class MyPanel1_3p2 extends RoundedPanel{
...
class MyPanel1_4p2 extends RoundedPanel{
...
class MyPanel1_5p2 extends RoundedPanel{
...
class MyPanel1_6p2 extends RoundedPanel{
